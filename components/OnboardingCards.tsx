  ...
  return (
    <div className="flex flex-col items-center w-full max-w-2xl mx-auto gap-8">
      ...
      <div className="flex flex-col items-center w-full mb-2 mt-8">
        ...
        <h1 className="text-3xl leading-tight font-bold lg:text-5xl xl:text-6xl text-center mb-2">Expertu meklētājs.</h1>
        <p className="text-muted-foreground text-sm text-center mb-4">Meklē uzticamu informāciju ar MI.</p>
      </div>
      {/* Cards Section */}
